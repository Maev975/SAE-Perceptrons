...
import sae.TreeSearchAndGame.ia.framework.jeux.GameEngine;
import sae.TreeSearchAndGame.ia.framework.jeux.*;


import sae.TreeSearchAndGame.*;

import static sae.TreeSearchAndGame.ia.framework.common.ArgParse.makeGame;
...
public class LancerJeux {
    ...
    public static void main(String[] args){
        ...
        Game game = makeGame(game_name, args);
