package sae.TreeSearchAndGame.ia.framework.common;

import java.util.Arrays;

import sae.TreeSearchAndGame.ia.framework.common.*;
import sae.TreeSearchAndGame.ia.framework.recherche.*;
import sae.TreeSearchAndGame.ia.framework.jeux.*;
import sae.TreeSearchAndGame.ia.problemes.*;
import sae.TreeSearchAndGame.ia.algo.recherche.*;
import sae.TreeSearchAndGame.ia.algo.jeux.*;
...
public class ArgParse {
    ...
    public static Player makePlayer(String p_type, Game game,
        ...
        case "minmax":
            ...
            case "alphabeta":
            return new AlphaBeta(game, is_p1);
//            getValueOfParam(args, "-d", -1);
        default :
